...
- *(uper)* empty outer encoding ([#466](https://github.com/librasn/rasn/pull/466))

### Other

- allow nightly fail, nightly clippy ([#485](https://github.com/librasn/rasn/pull/485))
...
## [0.28.13](https://github.com/AMCON-GmbH/rasn/compare/rasn-v0.28.12...rasn-v0.28.13) - 2026-04-24
...
## [0.28.9](https://github.com/librasn/rasn/compare/rasn-v0.28.8...rasn-v0.28.9) - 2026-03-10

### Added

- Implement Default trait for FixedOctetString ([#522](https://github.com/librasn/rasn/pull/522))
- *(type,jer)* implement Encode/Decode on `serde_json::Value` ([#538](https://github.com/librasn/rasn/pull/538))

### Fixed

- BER encoding of tagged CHOICE ([#521](https://github.com/librasn/rasn/pull/521))
- *(uper)* correctly decode extension bitmap length per X.691 §11.9.3.4 ([#541](https://github.com/librasn/rasn/pull/541))

## [0.28.8](https://github.com/librasn/rasn/compare/rasn-v0.28.7...rasn-v0.28.8) - 2026-02-20

### Other

- Improve en-/decode error messages ([#536](https://github.com/librasn/rasn/pull/536))
...
## [0.28.7](https://github.com/librasn/rasn/releases/tag/rasn-v0.28.7) - 2026-01-22
...
- Adding AsnType/Encode/Decode implementations for Cow<_, T> ([#530](https://github.com/librasn/rasn/pull/530))
...
- *(ber)* [**breaking**] Explicit errors when decoding optional any, proper TLV extraction in sequence ([#504](https://github.com/librasn/rasn/pull/504))
...
- *(per)* Fix constrained length encoding/decoding for SIZE(0..65535) ([#493](https://github.com/librasn/rasn/pull/493))

## [0.27.0](https://github.com/librasn/rasn/compare/rasn-v0.26.6...rasn-v0.27.0) - 2025-06-19

### Fixed

- OctetString PartialEq implementation with arc-slice feature ([#476](https://github.com/librasn/rasn/pull/476))
...
- encode/decode for PhantomData ([#433](https://github.com/librasn/rasn/pull/433))

## [0.26.0](https://github.com/librasn/rasn/compare/rasn-v0.25.1...rasn-v0.26.0) - 2025-03-23

### Added

- *(bench)* Add seperate encode and rtt benchmarks for X.509 ([#432](https://github.com/librasn/rasn/pull/432))
...
- chore!(integer): Wrap integer in newtype wrapper to hide implementation ([#429](https://github.com/librasn/rasn/pull/429))
- Clarify error message for UnexpectedEmptyInput ([#427](https://github.com/librasn/rasn/pull/427))
